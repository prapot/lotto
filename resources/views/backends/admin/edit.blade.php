...
@section('content')
<form id="admin-edit" action="{{route('backends.admin.update',['id' => $admin->id])}}"  method="post" class="needs-validation" novalidate enctype="multipart/form-data">
    @csrf
    @method('put')
    <div class="card-header py-3">
        <div class="row">
            <div class="col-5 col-md-5 d-flex justify-content-md-start align-items-md-center">
                <h1 class="my-1 text-center text-md-left">แก้ไขผู้ดูแลระบบ</h1>
            </div>
        </div>
    </div>
