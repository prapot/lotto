...
@section('page_title', "Create Agnet")
@section('content')
<form id="agent-create" action="{{route('backends.agent.store')}}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
    @csrf

    <div class="card-header py-3">
        <div class="row">
            <div class="col-5 col-md-5 d-flex justify-content-md-start align-items-md-center">
                <h1 class="my-1 text-center text-md-left">สร้าง Agent</h1>
            </div>
        </div>
    </div>
    <div class="row">
